...
import { MapPin, Clock, DollarSign, Users, Star, Heart, ArrowLeft, Share2, CheckCircle2, CalendarDays } from "lucide-react";
...
export default function PackageDetails() {
  ...
  const confirmBooking = () => {
    bookMutation.mutate(
      ...
      { onSuccess: () => { setBookingOpen(false); navigate("/user/bookings"); } }
    );
  };
