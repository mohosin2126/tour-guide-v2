...
import { Search, Filter, MapPin, Clock, DollarSign, ShieldCheck, HeadphonesIcon, CreditCard, Award, ArrowRight, Compass, Globe } from "lucide-react";
    ...
    <div className="min-h-screen pb-16">
      <PageHero
        ...
        ctaButtons={[
          ...
          { label: "Meet Our Guides", href: "/guides", variant: "outline" },
        ]}
        stats={[
          { icon: Globe, value: "50+", label: "Destinations" },
          { icon: Award, value: "500+", label: "Packages" },
